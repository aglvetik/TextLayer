...
public sealed class UiTextService : INotifyPropertyChanged
{
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["Common.InDevelopmentForRussian"] = "In development for Russian",
        ["Common.AccurateRequiredForMixed"] = "Dual English/Russian OCR uses the mixed pipeline",
        ...
        ["ControlCenter.OcrLanguageHelper"] = "Choose English for English-only screenshots. Choose Russian for Cyrillic text; Accurate OCR also keeps embedded English technical tokens.",
        ["ControlCenter.OcrRecommendation.English"] = "Fast OCR recommended for English captures.",
        ["ControlCenter.OcrRecommendation.Russian"] = "Russian uses Accurate OCR with combined Russian + English recognition. Fast OCR for Russian is still in development.",
        ...
        ["State.RecognizingDescription.FastRussian"] = "Russian currently uses Accurate OCR because Fast OCR for Russian is still in development.",
        ...
        ["OcrLanguage.Mixed"] = "Mixed (English + Russian)",
    ...
    private static readonly IReadOnlyDictionary<string, string> Russian = new Dictionary<string, string>
    {
        ...
        ["Common.InDevelopmentForRussian"] = "Для русского пока в разработке",
        ...
        ["ControlCenter.OcrLanguageHelper"] = "Выбирайте английский для чисто английских скриншотов. Выбирайте русский для кириллицы; режим Accurate также сохраняет встроенные английские технические токены.",
        ["ControlCenter.OcrRecommendation.English"] = "Для английских захватов рекомендуется Fast OCR.",
        ["ControlCenter.OcrRecommendation.Russian"] = "Для русского используется Accurate OCR с комбинированным распознаванием русского и английского. Fast OCR для русского пока в разработке.",
        ...
        ["State.RecognizingDescription.FastRussian"] = "Для русского TextLayer сейчас использует Accurate OCR, потому что Fast OCR для русского ещё в разработке.",
