...
public sealed class UiTextService : INotifyPropertyChanged
{
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["ControlCenter.OcrRecommendation.Russian"] = "Russian currently uses Accurate OCR. Fast OCR for Russian is still in development.",
    ...
    private static readonly IReadOnlyDictionary<string, string> Russian = new Dictionary<string, string>
    {
        ...
        ["ControlCenter.OcrRecommendation.Russian"] = "Для русского сейчас используется только Accurate OCR. Fast OCR для русского ещё в разработке.",
